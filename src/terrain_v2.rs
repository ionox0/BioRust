...
use crate::seamless_texture::create_seamless_terrain_texture;
...
pub fn generate_terrain_chunk_v2(
    ...
    let material = if let Some(cached_mat) = cached_material {
        ...
        // Create a simple material without texture to avoid flickering
        materials.add(StandardMaterial {
            base_color: Color::srgb(0.6, 0.5, 0.4), // Earthy terrain color
            perceptual_roughness: 0.9, // High roughness for natural terrain
            metallic: 0.0, // No metallic reflection
            reflectance: 0.1, // Low reflectance for matte finish
            cull_mode: Some(bevy::render::render_resource::Face::Back),
