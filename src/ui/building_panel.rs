...
fn create_unit_buttons(parent: &mut ChildBuilder, ui_icons: &UIIcons, game_costs: &crate::core::resources::GameCosts) {
    ...
    let unit_data = [
        ...
        // Team-specific resource gatherers
        (
            UnitType::DungBeetle,
            ui_icons.worker_icon.clone(),
            "Dung Beetle",
            get_cost(UnitType::DungBeetle),
            BuildingType::Queen,
        ),
        (
            UnitType::Silverfish,
